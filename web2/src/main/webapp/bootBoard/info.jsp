...
<!--[if lt IE 9]>
    ...
    <script type="text/javascript">
     $(function(){
    	 $("i[lang='ii']").click(function(){
    		if(${info.fileName ne 'noimg.jpg'}){
    			document.location.href='/web/download.do?fileName='+this.id;
    		}else{
    			alert('Downlos Fail');
    			return false;
    		} 
    	 });
    	 $("a#sck").click(function(){
    		alert('스크랩 확인');
    		document.location.href='/web/infoCheck.do?no=${info.no}';
    	 });
     });
    </script>
...
<jsp:include page="/bootBoard/header.jsp"></jsp:include>
		...
		<div class="list-group">
			<div class="list-group-item board-title">
				<div class="board-title">
					<span class="board-category">[${info.id}]</span><a href="#">
						${info.title}</a> 
				</div>
				<div class="board-meta"
					...
					<p>
					    ...
					    <i class="glyphicon glyphicon-thumbs-up">0</i> 
						<i class="glyphicon glyphicon-thumbs-down">0</i> 
					</p>
				</div>
				<div class="clear"></div>
			</div>
			<div class="list-group-item">
				...
				<img alt="" src="/web/upload/${info.fileName}" width="200" height="200">
				<br>
				${info.contents}
				</span>
				<p style="text-align: center; margin-top: 30px">
					...
					<button class="btn btn-warning">
						<i lang="ii" class="glyphicon glyphicon-thumbs-down" id="${info.fileName}">${info.fileName} ${info.fileName ne 'noimg.jpg'?'다운로드':'다운로드불가'}</i>
					</button>
				</p>
			</div>
			<div class="bottom" style="margin: 10px;margin-top: 20px; text-align: right">
				<a href="/web/mvcList.do" class="btn btn-default btn-xs pull-left">목록으로</a> 
				...
				<a href="#" id="sck" class="btn btn-default btn-xs">스크랩</a> 
			</div>
			<div class="clear"></div>
		</div>
	</div>
