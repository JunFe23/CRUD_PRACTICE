	...
	<div class="board-field">
		...
		<div class="col-md-8">
			<div class="board-toolbar" 	style="text-align: right; margin-bottom: 20px">
				...
				<a href="bootBoard/write.jsp" class="btn btn-primary btn-sm"><i
					class="glyphicon glyphicon-pencil" style="margin-right: 15px"></i>쓰기</a>
			</div>
			<div class="list-group">

               <c:forEach var="i" items="${bList}" varStatus="cnt">
				<a href="/web/hitBoard.do?no=${i.no}&job=info&page=10" class="list-group-item">
					<div class="board-title">
						<span class="board-category">[${i.id}]</span>
