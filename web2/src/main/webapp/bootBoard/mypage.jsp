...
<script type="text/javascript">
    $(function(){
	  $("button.pull-right").click(function(){
	    	 document.location.href='/web/infoCheck.do?job=del&no='+this.id;
		...
		<div class="col-md-8">
			<div class="list-group col-md-12">
				<a class="list-group-item list-group-item-warning">스크랩한 게시글</a> <a
					...
					<c:forEach var="i" items="${my}">
					<div>
					<div class="board-title">
						<span class="board-category">[${i.title}]</span> ${i.id } <span
							class="badge">New</span>
						<button lang="del" class="pull-right" style="margin-top: 10px" id="${i.no}">삭제</button>	
					</div>
