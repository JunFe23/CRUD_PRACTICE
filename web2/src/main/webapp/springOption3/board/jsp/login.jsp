 ...
 <div id="loginWrapper">
  <div class="loginForm">
   <fieldset>
    ...
    <dl>
     <dt><img src="/web/springOption3/board/img/common/th_id.gif" alt="아이디" /></dt>
     <dd><input type="text" name="id" class="text" id="id" /></dd>

     <dt><img src="/web/springOption3/board/img/common/th_pw.gif" alt="비밀번호" /></dt>
    ...
    <input type="checkbox" id="checker" name="checker" /> 
     <img src="/web/springOption3/board/img/common/save_id.gif" alt="아이디 저장" />
    </div>
   </fieldset>
